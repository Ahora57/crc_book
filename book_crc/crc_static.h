...
namespace crc_static
{
	...
	public:
		...
		//In read protecthion will be get rip base address(call % sub,lea reg,[rip] or "offset"(addr_mod)
        NO_INLINE auto  crc_static_check(PVOID addr_mod) -> BOOLEAN
		{  
